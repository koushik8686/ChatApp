...
export default function Usernav(params) {
    const router = useRouter();
    const handleLogout = () => {
      // Remove the authentication cookie
      Cookies.remove('user'); // Change 'authToken' to the name of your cookie
      router.push('/user/login'); // Change '/login' to your desired route
    };
  return (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <div className="hidden md:flex items-center space-x-4">
              <p onClick={params.onExpertsClick} className="text-gray-300 hover:text-white cursor-pointer">Experts</p>
              <p onClick={params.onChatsClick} className="text-gray-300 hover:text-white cursor-pointer">Chats</p>
              <p onClick={params.onRequestsClick} className="text-gray-300 hover:text-white cursor-pointer">My Requests</p>
